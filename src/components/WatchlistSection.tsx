...
export default function WatchlistSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 bg-white/20 dark:bg-[#000042]/20 backdrop-blur-xl rounded-xl border border-white/40 dark:border-white/30 shadow-[0_8px_32px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)] mt-14">
